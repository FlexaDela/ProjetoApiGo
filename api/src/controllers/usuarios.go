...
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if erro = usuario.Preparar("edicão"); erro != nil {
		respostas.Erro(w, http.StatusBadRequest, erro)
		return
	}
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	usuarioIDNoTokem, erro := autenticacao.ExtrairUsuarioID(r)
	if erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, erro)
		return
	}
	...
	if usuarioIDNoTokem != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é possivel atualizar"))
		return
	}
